...
<div class="title" style="position: relative;
  ...
  left: 0;
  padding: 10px 20px;
  background: #000;color: #fff">刀耕火种的前端史</div>
...
<div class="title" style="position: relative;
  ...
  left: 0;
  padding: 10px 20px;
  background: #000;color: #fff">Flash的没落</div>
...
<div class="title" style="position: relative;
  ...
  left: 0;
  padding: 10px 20px;
  background: #000;color: #fff">2D的世界</div>
...
<div class="title" style="position: relative;
  ...
  left: 0;
  padding: 10px 20px;
  background: #000;color: #fff">带你了解CSS3的世界</div>
...
<div class="title" style="position: relative;
  ...
  left: 0;
  padding: 10px 20px;
  background: #000;color: #fff">timing-function</div>
...
<div class="title" style="position: relative;
  ...
  left: 0;
  padding: 10px 20px;
  background: #000;color: #fff">带你了解Velocity.js</div>
...
<div class="title" style="position: relative;
  ...
  left: 0;
  padding: 10px 20px;
  background: #000;color: #fff">Velocity.js用法</div>
...
<div class="title" style="position: relative;
  ...
  left: 0;
  padding: 10px 20px;
  background: #000;color: #fff">Velocity的链式动画</div>
<pre><code class="javascript">
$element
  /* 先执行宽度变为75px的动画 */
  .velocity({ width: 75 })
...
<div class="title" style="position: relative;
  ...
  left: 0;
  padding: 10px 20px;
  background: #000;color: #fff">Velocity的时间轴动画</div>
<pre><code class="javascript">
  const enterAn = [{
    elements: cloud1,
...
<div class="title" style="position: relative;
  ...
  left: 0;
  padding: 10px 20px;
  background: #000;color: #fff">动画开发流程</div>
